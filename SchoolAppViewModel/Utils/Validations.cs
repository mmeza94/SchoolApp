using SchoolAppViewModel.Views;
using System;
...
namespace SchoolAppViewModel.Utils
{
    public class Validations
    {
        ...
        LoginViewModel loginAppVM { get; set; }

        string LoginPassword { get => passwordbox.Password; }

        public Validations(string Email, PasswordBox passwordbox, LoginViewModel loginAppVM)
        {
